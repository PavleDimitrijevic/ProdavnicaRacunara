...
import models.TableModelTipRacunara;

/**
 *
 * @author PAVLE
 */
public class FormPretragaTipaRacunara extends javax.swing.JDialog {

    public FormPretragaTipaRacunara(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setLocationRelativeTo(null);
        TableModelTipRacunara model = new TableModelTipRacunara();
        Thread th = new Thread(model);
        th.start();
        tblTipovi.setModel(model);
        setTitle("Pretraga tipa racunara");
    }
    ...
    private void initComponents() {
        ...
        btnDetalji.setText("Detalji tipa racunara");
    ...
    private void txtPretragaKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtPretragaKeyReleased
        ...
        ((TableModelTipRacunara) tblTipovi.getModel()).setParametar(param);
    }//GEN-LAST:event_txtPretragaKeyReleased

    private void btnDetaljiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDetaljiActionPerformed

        int row = tblTipovi.getSelectedRow();
    ...
    void refreshTable() {
        TableModelTipRacunara tm = (TableModelTipRacunara) tblTipovi.getModel();
        tm.refreshTable();
    }
